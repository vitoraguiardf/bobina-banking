...
const destroyItem = (item) => {
    form.delete(route('bobina-banking.accounts.key.email.destroy', item.id), {
        onSuccess: () => {
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex">
                    ...
                    <div class="flex-row-reverse">
                        <Button as="a" label="Create new" :href="route('bobina-banking.accounts.key.email.create')" link disabled />
                    </div> 
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <DataTable :value="items" stripedRows removableSort sortMode="multiple"
                        ...
                        <Column field="address" header="Email" sortable>
