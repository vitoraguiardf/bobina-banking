...
const destroyItem = (item) => {
    form.delete(route('bobina-banking.accounts.key.random.destroy', item.id), {
        onSuccess: () => {
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex">
                    ...
                    <div class="flex-row-reverse">
                        <Button as="a" label="Create new" :href="route('bobina-banking.accounts.key.random.create')" link disabled />
                    </div> 
                </div>
