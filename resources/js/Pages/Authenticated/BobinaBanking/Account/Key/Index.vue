...
const destroyItem = (item) => {
    /*form.delete(route('bobina-banking.accounts.key.destroy', item.id), {
        onSuccess: () => {
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex">
                    ...
                    <div class="flex-row-reverse">
                        <!--Button as="a" label="Create new" :href="route('bobina-banking.accounts.key.create')" link disabled /-->
                    </div> 
                </div>
                        ...
                        <Column field="key" header="Key" sortable>
                            <template #body="slotProps">
                                <div class="flex flex-col">
                                    <span class="text-gray-800 dark:text-gray-200">{{ slotProps.data.key.name }}</span>
                                ...
                                <div class="flex flex-col">
                                    <span class="text-gray-800 dark:text-gray-200">
                                        ...
                                        <small class="text-gray-600 dark:text-gray-400">
                                            {{ slotProps.data.account.holder_name }}
                                        </small>
                                    </span>
                                </div>
                            </template>
